...
export const UsageStats = ({ totalMailboxes, storageUsed, totalThreats }: UsageStatsProps) => {
  ...
  return (
    <div className="flex flex-col gap-6 rounded-3xl bg-background border border-primary-100 p-8 h-full shadow-sm">
      <Text size="lg" font="bold">Usage & Performance</Text>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <Text size="xs" color="primary-400" className="uppercase tracking-widest font-bold">{stat.label}</Text>
                <Text size="sm" color="primary-500" className="mt-0.5">{stat.description}</Text>
              </div>
            </div>
            <Text size="xl" font="bold" color="primary-950">{stat.value}</Text>
          </motion.div>
        ))}
      </div>

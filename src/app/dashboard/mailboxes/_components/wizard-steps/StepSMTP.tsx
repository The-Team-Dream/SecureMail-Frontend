...
export function StepSMTP({ register, errors }: WizardStepProps) {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full flex flex-col items-center">
      ...
      <div className="w-full flex-col gap-6 text-left max-w-lg mx-auto">
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="col-span-1 flex flex-col justify-end">
            ...
            <div className="relative">
              <select
                className={`w-full h-12 px-4 border text-[14px] text-primary-900 rounded-xl outline-none transition duration-500 appearance-none bg-card ${errors?.smtpSecurity ? 'border-error-500' : 'border-primary-100 focus:border-primary-400'}`}

        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="col-span-1 flex flex-col justify-end">
            ...
            <div className="relative">
              <select
                className={`w-full h-12 px-4 border text-[14px] text-primary-900 rounded-xl outline-none transition duration-500 appearance-none bg-card ${errors?.imapSecurity ? 'border-error-500' : 'border-primary-100 focus:border-primary-400'}`}
